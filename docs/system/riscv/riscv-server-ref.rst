...
The initial ``riscv-server-ref`` RPMI implementation exposes Base, System
Reset, HSM, and System Suspend service groups.  System Reset handles guest
shutdown and cold reboot requests through RPMI.
